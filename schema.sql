...
CREATE TABLE `categories` (
  ...
  `icon` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL
...
CREATE TABLE `files` (
  ...
  `path` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_general_ci;
...
--
ALTER TABLE `files`
  ADD CONSTRAINT `files_users__fk` FOREIGN KEY (`file_id`) REFERENCES `users` (`avatar_file_id`);
